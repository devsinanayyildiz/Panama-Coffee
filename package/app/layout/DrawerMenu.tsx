    ...
    return (
        <ScrollView contentContainerStyle={{flexGrow:5}}>
            ...
            >
                ...
                >
                    <Text style={{...FONTS.fontSemiBold,fontSize:20,color:colors.title}}>Ana Menu</Text>
                    <TouchableOpacity
                        ...
                        return(
                            ...
                            >
                                <View style={{flexDirection:'row',alignItems:'center',gap:20}}>
                                    ...
                                    <Text style={[FONTS.fontRegular,{color:colors.title,fontSize:16,opacity:0.6},data.id === '0' && {...FONTS.fontSemiBold,fontSize:16,color:COLORS.primary}]}>{data.name}</Text>
                                </View>
                            </TouchableOpacity>
                        );
                    })}
                ...
                <View style={{paddingVertical:230,paddingHorizontal:3}}>
