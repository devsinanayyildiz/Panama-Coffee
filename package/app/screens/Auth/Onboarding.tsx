...
const DATA = [
    {
        title: 'PANAMA COFFEE',
        subtitle:'Panama Coffee’de her yudumda ayrı bir keyif saklı! Özenle seçilmiş kahvelerimizle enerjik bir başlangıç yaparken, tatlılarımız ve atıştırmalıklarımızla gününüze neşe katıyoruz. Ferahlatıcı, kahve dışı içecek seçeneklerimiz ise size doğal tazeliği sunuyor. Her bir detayda kaliteyi ve mutluluğu bulacağınız bu eşsiz deneyimle, gününüzü güzelleştirin!',
    }
];
...
const Onboarding = ({navigation} : OnboardingScreenProps) => {
    ...
    const IndexImage = [IMAGES.onborder5];
    ...
    const handleContinue = async () => {
        await AsyncStorage.setItem('hasSeenOnboarding', 'true');  // ✅ Onboarding bilgisini sakla
        navigation.replace('WelCome');  // ✅ Devam ettikten sonra Welcome ekranına yönlendir
    };
