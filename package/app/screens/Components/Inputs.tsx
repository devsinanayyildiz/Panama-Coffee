                    ...
                    <View style={[GlobalStyleSheet.card,{backgroundColor:colors.card}]}>
                        ...
                        <View style={[GlobalStyleSheet.card,{backgroundColor:colors.card}]}>
                            ...
                            <View style={GlobalStyleSheet.cardBody}>
                                <View style={{marginBottom:10}}>
                                    <Input
                                        icon={<FontAwesome style={{opacity:0.6}} name={'user'} size={20} color={colors.title}/> }
                                        //value={''}
                                        placeholder="Enter Username"
                                        onChangeText={(value)=> console.log(value)}
                                    />
                                ...
                                <View style={{marginBottom:10}}>
                                    <Input
                                        icon={<MaterialIcon style={{opacity:0.6}} name={'email'} size={20} color={colors.title}/>}
                                        //value={''}
                                        placeholder="Enter Email"
                                        onChangeText={(value)=> console.log(value)}
                                    />
                                ...
                                <View style={{marginBottom:10}}>
                                    <Input
                                        type={'password'}
                                        icon={<FontAwesome style={{opacity:0.6}} name={'lock'} size={20} color={colors.title}/> }
                                        //value={''}
