    ...
    return (
        <>
            <View style={{
                ...
                >
                    <Text style={{...styles.theadItem,color:colors.text,flex:0.6,paddingLeft:15}}>Name</Text>
                ...
                {TableData.map((data,index) => {
                    return(
                        ...
                        >
                            <Text style={{...styles.tbodyItem,color:colors.title,flex:0.6,paddingLeft:15}}>{data.name}</Text>
